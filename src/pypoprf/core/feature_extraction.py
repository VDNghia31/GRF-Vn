...
class FeatureExtractor:
    ...
    def extract(self,
        ...
        if avg_only:
            ...
            lower_map = {c.lower(): c for c in res.columns}
            if 'lon' in lower_map and 'lat' in lower_map:
                cols.extend([lower_map['lon'], lower_map['lat']])
            elif 'x' in lower_map and 'y' in lower_map:
                cols.extend([lower_map['x'], lower_map['y']])
            res = res[cols]
