...
from ..core.model_grf import ModelGRF
...
@click.option('--no-viz',
              is_flag=True,
              help='Skip visualization')
def run_grf(config_file: str,
            verbose: bool,
            no_viz: bool,
            model_path: str) -> None:
    """Run the complete population modeling workflow using GRF model."""
    logger.info(f"Starting GRF population modeling workflow with config: {config_file}")
    ...
    logger.info("GRF population modeling completed successfully!")
    return
